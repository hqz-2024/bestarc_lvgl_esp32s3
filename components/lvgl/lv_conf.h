...
LV_FONT_DECLARE(bestarc_BBHBogle_18)\
LV_FONT_DECLARE(bestarc_BBHBogle_32)\
LV_FONT_DECLARE(bestarc_BBHBogle_48)\
LV_FONT_DECLARE(bestarc_BBHBogle_64)\
LV_FONT_DECLARE(bestarc_BBHBogle_80)\
LV_FONT_DECLARE(bestarc_BBHBogle_128)
